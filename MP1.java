...
//January 17, 2015
	public static void main(String[] args) {
		...
		final double ENGINE_W = 55.0, ENGINE_L = 52.0, ENGINE_PP = 1000.0; 
		double totalBW = 0.0, totalBL = 0.0, totalGW = 0.0, totalGL = 0.0, totalPW = 0.0, totalPL = 0.0;
		double totalEngine = 0.0, totalEW = 0.0, totalEL = 0.0; 
		...
		System.out.printf("The number of engines required is %2.0f%n", totalEngine);
